...
func RunSuite(t *testing.T, factory BackendFactory) {
	...
	t.Run("gate_agent_evaluator_context_evidence", func(t *testing.T) { testGateAgentEvaluatorContextEvidence(t, factory) })
	...
	t.Run("gate_evaluator_context_evidence_resume", func(t *testing.T) { testGateEvaluatorContextEvidenceResume(t, factory) })
