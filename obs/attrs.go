...
const (
	...
	AttrAgentEventLive           = "awf.agent.event.live"
	AttrAgentEventDisplayClass   = "awf.agent.event.display_class"
	AttrAgentEventDisplayTool    = "awf.agent.event.display_tool"
	AttrAgentEventDisplaySummary = "awf.agent.event.display_summary"
	AttrAgentEventDisplayLines   = "awf.agent.event.display_lines"
	AttrAgentEventDisplayBytes   = "awf.agent.event.display_bytes"
	AttrAgentEventDisplayIsError = "awf.agent.event.display_is_error"
